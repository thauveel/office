                ...
                <div
                    ...
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-teal-50 text-teal-700 ring-4 ring-white">
                            <svg class="h-6 w-6" x-description="Heroicon name: outline/users"
                    ...
                    <div class="mt-8">
                        <h3 class="text-lg font-medium">
                            <a href="{{route('hrm.dashboard')}}" class="focus:outline-none">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Departments, Jobs, Employess, Schedule, Attendance, Leaves.
                        </p>
                    </div>
                ...
                <div
                    ...
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-purple-50 text-purple-700 ring-4 ring-white">
                            <svg class="h-6 w-6" x-description="Heroicon name: outline/check-badge"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    ...
                    <div>
                        <span class="rounded-lg inline-flex p-3 bg-yellow-50 text-yellow-700 ring-4 ring-white">
                            <svg class="h-6 w-6" x-description="Heroicon name: outline/banknotes"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
